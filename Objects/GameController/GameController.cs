...
public partial class GameController : Node
{
	...
	public override void _Ready()
	{
		...
		Game.AudioController.TransitionInstantlyUsing(MainMenuTracks);
	}
...
static public class Game
{
	...
	public static InputRemapper InputRemapper => GameController.Instance.inputRemapper;

	static public class PackedScenes
	{
		public static PackedScene Level => Controller.LevelPackedScene;
		public static PackedScene Battle => Controller.BattlePackedScene;
		public static PackedScene LevelHud => Controller.LevelHudPackedScene;
		public static PackedScene Player => Controller.PlayerPackedScene;
	}
}
