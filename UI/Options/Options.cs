...
public partial class Options
{
	...
	public float SpeedCritModifier {get; set;} = 1.0f;
	...
	[OptionGroup("Volume")]
	[OptionSlider] public float MasterVolume {get; set;} = 0.0f;
	[OptionSlider] public float MusicVolume {get; set;} = 1.0f;
	[OptionSlider] public float UIVolume {get; set;} = 1.0f;
	[OptionSlider] public float PlayerVolume {get; set;} = 1.0f;
	[OptionSlider] public float AmbientVolume {get; set;} = 1.0f;
